...
<template>
    ...
    >
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'action'">
          <a-space>
            <a-button type="link" size="small" @click="openEdit(record as Role)">编辑</a-button>
            <a-popconfirm title="确认删除？" @confirm="handleDelete((record as Role).id)">
  ...
  <a-modal v-model:open="modalVisible" :title="editingId ? '编辑角色' : '新建角色'" @ok="handleSubmit">
    <a-form ref="formRef" :model="form" layout="vertical">
      <a-form-item label="角色名" name="name" :rules="[{ required: true }]">
